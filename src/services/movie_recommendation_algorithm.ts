...
const REVIEW_TAG_MATCH_MAP: Record<ReviewTag, string[]> = {
  ...
  '내 2시간 돌려내요': ['몰입감', '빠른전개'],
  '스토리는 전개가 너무 느렸어요': ['탄탄한 스토리', '몰입감', '빠른전개'],
  '이야기가 이해하기 어려웠어요': ['탄탄한 스토리', '세계관'],
  '결말이 아쉬웠어요': ['탄탄한 스토리', '여운', '감동'],
  '몰입하기 어려웠어요': ['몰입감', '빠른전개', '탄탄한 스토리'],
  '주인공에게 공감이 안됐어요': ['캐릭터', '캐릭터 매력'],
  '캐릭터가 매력적이지 않았어요': ['캐릭터 매력', '캐릭터'],
  '배우연기가 아쉬웠어요': ['배우들의 연기력'],
  '등장인물이 너무 많았어요': ['캐릭터', '탄탄한 스토리'],
  '영상미가 아쉬웠어요': ['영상미', '연출'],
  '장면 전환이 아쉬웠어요': ['연출', '몰입감'],
  '연출 의도를 이해하기 어려웠어요': ['연출', '세계관'],
  'CG가 너무 어색했어요': ['영상미', '연출', '액션', '세계관'],
  '액션이 부자연스러워요': ['액션', '연출', '몰입감'],
  '긴장감이 부족했어요': ['긴장감', '몰입감'],
  '유머가 제취향이 아니었어요': ['유머', '유쾌함'],
  '감정선이 부족했어요': ['감동', '여운']
};
